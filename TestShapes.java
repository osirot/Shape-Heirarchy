 ...
 * @version 0.1 (standard) shape heirarchy
 */
    ...
    public void test() {
        ...
        for(input = showMenu(); input != 0; input = showMenu()) {
            ...
            if(input == 1) {
                ...
                //create a MyEllipse
                height = getInt("Enter the minor axis (b): ");
                width= getInt("Enter the major axis(a): ");
            ...
            if(shape != null) {
                ...
                System.out.println("You created a " + shape.getName() + 
                    ...
                    shape.getHeight() + ".");
                System.out.format("  Its area is %.3f ",  shape.getArea());
                System.out.format( " Its perimeter is %.3f. ", shape.getPerimeter());
            } else {
                // report the error
